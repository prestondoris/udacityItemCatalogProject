...
beer2 = Beer(
    ...
    description = 'We are huge fans of IPA and love our hops like anyone else, but we also like to have fun. Our Blah Blah Blah IPA is a tongue-in-cheek commentary on the popularity of this style and all the sub-styles that have become part of craft beer conversations and offerings.',
    style = 'IPA',
    brewery = brewery1
)
...
beer2 = Beer(
    name = 'Torpedo IPA',
    description = 'Sierra Nevada and hops go hand in hand. What began as a crazy idea scribbled in a pub eventually became our newest year-round hop bomb, Torpedo Extra IPA. The first beer to feature our “Hop Torpedo”—a revolutionary dry-hopping device that controls how much hop aroma is imparted into beer without adding additional bitterness. Torpedo Extra IPA is an aggressive yet balanced beer with massive hop aromas of citrus, pine, and tropical fruit.',
    style = 'IPA',
    brewery = brewery2
)
...
beer1 = Beer(
    name = 'Go To IPA',
    description = 'For Stone Go To IPA, we embrace our hop obsession in a new way, funneling an abundance of lupulin-borne bitterness into a session IPA that delivers all the fruity, piney character of a much bigger IPA. ',
    style = 'Session IPA',
    brewery = brewery4
)
...
beer1 = Beer(
    name = 'Pils',
    description = 'Our only Unlimited Lager, brewed with loads of imported Saaz hops and a bottom-fermenting yeast strain that leaves it Light and Crisp and Easy to Slam, yet full of real flavor and all the things you yearn for.',
    style = 'Pilsner',
    brewery = brewery5
)
